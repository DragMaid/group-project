...
-- CreateIndex
CREATE UNIQUE INDEX "PostContent_fileId_key" ON "PostContent"("fileId");
...
-- AddForeignKey
ALTER TABLE "Follow" ADD CONSTRAINT "Follow_followedId_fkey" FOREIGN KEY ("followedId") REFERENCES "User"("linked_account") ON DELETE CASCADE ON UPDATE CASCADE;
